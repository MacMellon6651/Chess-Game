...
class GameRoom : public std::enable_shared_from_this<GameRoom> {
    public:
        ...
        void on_move(const std::shared_ptr<Session>& from, const std::string& from_sq, const std::string& to_sq);
        ...
        std::shared_ptr<Session> a() const { return _a; }
        std::shared_ptr<Session> b() const { return _b; }
